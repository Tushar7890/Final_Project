...
const Login = () => {
  ...
  return (
    <div style={{ position: "relative", overflow: "hidden" }}>
      ...
      >
        <Row>
          <h1 className="text-light text-center">Welcome to ExpenseGo</h1>
          <br/>
          <Col md={{ span: 6, offset: 3 }}>
            ...
            <h2 className="text-white text-center">Login to continue</h2>
            <Form>
              ...
              >
                ...
                <p className="mt-3 text-light" color={{ color: "#343a40" }}>
