...
const SetAvatar = () => {
  ...
  return (
    ...
    {loading === true? (
        <>
            {/* <Container></Container> */}
            <div className="container containerBox" h ={"100vh"} style={{position: 'relative', zIndex: "2 !important"}}>
        ...
        <>
            <div className="container containerBox" style={{position: 'relative', zIndex: "2 !important"}}>
                <div className="avatarBox" >
                    ...
                    <Button  onClick={setProfilePicture}  type="submit" className="mt-5" >Set as Profile Picture</Button>
                </div>
